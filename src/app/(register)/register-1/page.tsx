...
function RegisterFormModal({ onClose }: RegisterFormModalProps) {
  const [currentPage, setCurrentPage] = useState(1);

  const renderFormPage = () => {
    switch (currentPage) {
      case 1:
        return <Page1Form goToNextPage={() => setCurrentPage(2)} />;
      case 2:
        return (
          <Page2Form
            goToNextPage={() => setCurrentPage(3)}
            goToPreviousPage={() => setCurrentPage(1)}
          />
        );
      case 3:
        return (
          <Page3Form
            ...
            goToPreviousPage={() => setCurrentPage(2)}
          />
        );
      case 4:
        return <Page4Form goToPreviousPage={() => setCurrentPage(3)} />;
      default:
        return <Page1Form goToNextPage={() => setCurrentPage(2)} />;
    }
  };
      ...
      <div className="relative xl:top-[15%] lg:top-[30%] md:top-[15%] md:left-[10%] md:grid w-[80%] grid-cols-4 ">
        ...
        <div className="md:col-span-3 bg-white w-screen md:h-auto h-screen md:w-auto py-14 px-8">
          <div className="flex justify-between">
            <div>
              <p className="text-[#012148] font-semibold text-2xl">
