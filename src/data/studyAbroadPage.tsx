...
export const studyAbroadData = {
  homeBanner: {
    ...
    text1:
      "Explore Top Universities Worldwide and Transform \n Your Future with Expert Guidance",
    button1: {
  ...
  section4: {
    ...
    text2:
      "Raj transformed his aspirations into reality by securing admission to <br> MIT. With our  personalized guidance, he navigated the complexities <br> of studying abroad and achieved his dream",
    button1: {
      text: "Read More",
      href: "#",
    },
